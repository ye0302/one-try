...
from client1.bll import ClientCoreController
from client1.model import Location
from client1.user_model import UserModel
...
class GameView:
    ...
    def __do_play(self):
        ...
        while True:
            ...
            if self.__handle(head):
                return
            self.__show()
            self.__outplay()

    def __handle(self, head):
        if head == "C":
